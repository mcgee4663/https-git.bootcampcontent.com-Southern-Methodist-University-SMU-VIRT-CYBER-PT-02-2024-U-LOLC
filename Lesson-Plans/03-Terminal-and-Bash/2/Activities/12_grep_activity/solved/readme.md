...
- The first step is to navigate into the folder on your virtual machine where the recipes are located. To do this, run the following commands:
...
-  Run the command, and notice the results show all four files, but five lines contain "guavaberries" OR "optional":
